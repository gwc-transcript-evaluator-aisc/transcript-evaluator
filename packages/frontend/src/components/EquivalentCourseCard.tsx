...
interface EquivalentCourseCardProps {
  course: Course;
}

export function EquivalentCourseCard({ course }: EquivalentCourseCardProps) {
  return (
            ...
            <div className="flex justify-between items-center">
              ...
              <HoverCard>
                ...
                <HoverCardContent className="w-60">
                  <p className="text-xs">{course.courseNumber} at {course.institutionName}</p>
                </HoverCardContent>
              </HoverCard>
            </div>
            <div className="flex justify-between items-center">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-xs italic text-muted-foreground">
                {course.grade || "C or better required"}
              </span>
            </div>
